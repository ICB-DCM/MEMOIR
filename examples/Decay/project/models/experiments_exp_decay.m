function Model = experiments_exp_decay(Model,S)
...
if ismember(1,S)
    ...
    Model.exp{s}.sym.phi = [beta(1);
        beta(2)+b(1)];
    Model.exp{s}.sym.sigma_noise = sym(1);
    ...
    Model.exp{s}.model = @(t,phi,kappa,options) nonlinfun(t,phi,kappa,options);
